...
let UserCard = (_dec = (0, _typeorm.Index)("user_cards_users_id_fk", ["user_id"], {}), _dec2 = (0, _typeorm.Entity)("user_card"), _dec3 = (0, _typeorm.PrimaryGeneratedColumn)(), _dec4 = Reflect.metadata("design:type", String), _dec5 = (0, _typeorm.Column)(), _dec6 = Reflect.metadata("design:type", String), _dec7 = (0, _typeorm.Column)(), _dec8 = Reflect.metadata("design:type", String), _dec9 = (0, _typeorm.CreateDateColumn)(), _dec10 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec11 = (0, _typeorm.UpdateDateColumn)(), _dec12 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec13 = (0, _typeorm.ManyToOne)(() => _User.default, user => user.cards, {
  onDelete: "CASCADE",
  onUpdate: "CASCADE"
}), _dec14 = (0, _typeorm.JoinColumn)([{
  name: "user_id",
  referencedColumnName: "id"
}]), _dec15 = Reflect.metadata("design:type", typeof _User.default === "undefined" ? Object : _User.default), _dec(_class = _dec2(_class = (_class2 = class UserCard {
  constructor() {
